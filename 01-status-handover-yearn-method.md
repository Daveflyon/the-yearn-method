...
Last updated 8 Sep 2026, after mobile UX fixes and 3 new story-bank entries went live.
...
- [ ] Decide how (or whether) to add an anxiety/mental-health angle to the story bank — Miriam noticed no match when a learner searched "anxiety"; this is a more sensitive category than dyslexia/ADHD/autism (health disclosure vs. learning difference) and may be worth a conversation with Miriam or Landau's safeguarding lead on framing before any names are added
...
- 17 story-bank entries (up from an original 9): Adele, Jay-Z, John Legend, Ian Wright, Stormzy, Marcus Rashford, Rihanna, Billy Joel, Lizzo, Dua Lipa, Tom Holland, Lewis Hamilton, Ed Sheeran, Richard Branson, Zayn Malik, Maya Hawke, Susan Boyle.
- All sections now default to collapsed on page load (previously "What This Is" and "Pick Today's Story" opened by default) — an "Expand all sections" / "Collapse all sections" toggle button added above Section 1 so the user never has to hunt through several opened sections to close them.
